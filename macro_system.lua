...
getgenv().Library = {
    ...
    -- 🌸 New Pink & Blue Semi-Transparent Theme 🌸
    local Themes = {
        Preset = {
            ["Accent"] = Color3.fromRGB(255, 105, 180), -- Hot Pink
            ["ElementBackground"] = Color3.fromRGB(30, 30, 40, 0.6), -- Semi-transparent dark
            ["SectionBackground"] = Color3.fromRGB(25, 25, 35, 0.5), -- Semi-transparent dark
            ["ElementOutline"] = Color3.fromRGB(60, 60, 80, 0.3),
            ["Inline"] = Color3.fromRGB(45, 45, 60, 0.4),
            ["Other"] = Color3.fromRGB(40, 40, 55, 0.3),
            ["TabButtons"] = Color3.fromRGB(30, 30, 45, 0.5),
            ["Unselected"] = Color3.fromRGB(180, 180, 200),
            ["TextColor"] = Color3.fromRGB(255, 255, 255),
            ["Background"] = Color3.fromRGB(20, 20, 30, 0.7), -- Semi-transparent dark
    ...
    Library.CreateWindow = function(self, Data)
        ...
        local Items = Cfg.Items; do
            ...
            -- // keybind list top
            Items.KeybindList = Library:Create("Frame",{ZIndex = 999; Parent = Library.HUD.Instance; Size = UDim2.new(0, 200, 0, 31); Position = UDim2.new(0, 37, 0, 401); BorderSizePixel = 0; ZIndex = 2; BackgroundColor3 = Themes.Preset["SectionBackground"]})
            Items.UIStroke = Library:Create("UIStroke",{Color = Themes.Preset["ElementOutline"]; Parent = Items.KeybindList.Instance})
            ...
            Items.Filler = Library:Create("Frame",{Parent = Items.KeybindList.Instance; Position = UDim2.new(0, -3, 1, -14); Size = UDim2.new(1, 6, 0, 18); BorderSizePixel = 0; BackgroundColor3 = Themes.Preset["SectionBackground"]})
            Items.BottomFiller = Library:Create("Frame",{AnchorPoint = Vector2.new(0, 1); Parent = Items.Filler.Instance; Position = UDim2.new(0, 0, 1, 0); Size = UDim2.new(1, 0, 0, 1); BorderSizePixel = 0; BackgroundColor3 = Themes.Preset["ElementOutline"]})
            ...
            Items.KeybindHolder = Library:Create("Frame",{ZIndex = 0; Parent = Items.KeybindList.Instance; Size = UDim2.new(0, 200, 0, 0); Position = UDim2.new(0, -2, 0, 18); BorderSizePixel = 0; BackgroundColor3 = Themes.Preset["SectionBackground"]})
            ...
            Items.UIStroke = Library:Create("UIStroke",{Color = Themes.Preset["ElementOutline"]; Parent = Items.KeybindHolder.Instance})

            -- // Modlist list top
            Items.ModList = Library:Create("Frame",{ZIndex = 999; Parent = Library.HUD.Instance; Size = UDim2.new(0, 200, 0, 31); Position = UDim2.new(0, 37 + 200 + 10, 0, 401); BorderSizePixel = 0; ZIndex = 2; BackgroundColor3 = Themes.Preset["SectionBackground"]})
            Items.UIStroke = Library:Create("UIStroke",{Color = Themes.Preset["ElementOutline"]; Parent = Items.ModList.Instance})
            ...
            Items.UIPadding = Library:Create("UIPadding",{PaddingTop = UDim.new(0, 4); PaddingBottom = UDim.new(0, 6); Parent = Items.Titles.Instance; PaddingRight = UDim.new(0, 5); PaddingLeft = UDim.new(0, 7)})
            Items.Filler = Library:Create("Frame",{Parent = Items.ModList.Instance; Position = UDim2.new(0, -3, 1, -14); Size = UDim2.new(1, 6, 0, 18); BorderSizePixel = 0; BackgroundColor3 = Themes.Preset["SectionBackground"]})
            Items.BottomFiller = Library:Create("Frame",{AnchorPoint = Vector2.new(0, 1); Parent = Items.Filler.Instance; Position = UDim2.new(0, 0, 1, 0); Size = UDim2.new(1, 0, 0, 1); BorderSizePixel = 0; BackgroundColor3 = Themes.Preset["ElementOutline"]})
            ...
            Items.ModHolder = Library:Create("Frame",{ZIndex = 0; Parent = Items.ModList.Instance; Size = UDim2.new(0, 200, 0, 0); Position = UDim2.new(0, -2, 0, 18); BorderSizePixel = 0; BackgroundColor3 = Themes.Preset["SectionBackground"]})
            ...
            Items.UIStroke = Library:Create("UIStroke",{Color = Themes.Preset["ElementOutline"]; Parent = Items.ModHolder.Instance})
        end
        ...
        Items.Watermark = Library:Create("CanvasGroup",{Parent = Library.HUD.Instance; Position = UDim2.new(0, 30, 0, 200); BorderSizePixel = 0; AutomaticSize = Enum.AutomaticSize.XY; BackgroundColor3 = Themes.Preset["SectionBackground"]}):Draggify()
    ...
    Library.InitConfigs = function(self, Window)
        ...
        Section:AddKeyPicker({Text = "Menu bind", Mode = "Toggle", ShowInList = false, Key = Enum.KeyCode.RightControl, Callback = function(Value)
    ...
    do -- Notification Library
        ...
        Library.Notify = function(self, Data)
            ...
            local Items = Cfg.Items; do
                Items.Notification = Library:Create("CanvasGroup",{GroupTransparency = 1; Parent = Library.HUD.Instance; Position = UDim2.new(0, 30, 0, 60); BorderSizePixel = 0; AutomaticSize = Enum.AutomaticSize.XY; BackgroundColor3 = Themes.Preset["SectionBackground"]})
        ...
        Library:Notify({ Text = '🌸 Pink UI Loaded!' })
    end
